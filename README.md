...
This is the beginning of the event generator for QuIPS. The intended layout of the project is given in `DESIGN.md`. Soon, there will be a link that you can click that gives a simple interactive demonstration of the output
